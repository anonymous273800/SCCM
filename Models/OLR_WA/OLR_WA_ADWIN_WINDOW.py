...
def olr_wa_regression_adwin_window(
    ...
    - Feed ADWIN with PER-SAMPLE squared error using the old committed model before adaptation
    ...
    for i in range(no_of_base_model_points, n_samples - no_of_base_model_points, increment_size):
        ...
        # --------------------------------------------------------
        # Feed ADWIN with PER-SAMPLE squared error using old committed model
        # --------------------------------------------------------
