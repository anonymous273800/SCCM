...
DATASET_PREFIX = 'IDS'
EXPERIMENT_MODEL_NAME = 'OLR-WA'
SUMMARY_FILE_MODEL_SLUG = 'OLRWA'
MODEL_LABEL = 'OLR-WA-SCCM'
DRIFT_TYPE = 'incremental'
DRIFT_DISPLAY = 'Incremental'

OUTPUT_BY_DATASET = SUMMARY_FOLDER / 'OLR_WA_Incremental_by_dataset.csv'
OUTPUT_OVERALL = SUMMARY_FOLDER / 'OLR_WA_Incremental_overall.csv'
