...
DATASET_PREFIX = 'IDS'
EXPERIMENT_MODEL_NAME = 'RLS'
SUMMARY_FILE_MODEL_SLUG = 'RLS'
MODEL_LABEL = 'RLS-SCCM'
DRIFT_TYPE = 'incremental'
DRIFT_DISPLAY = 'Incremental'

OUTPUT_BY_DATASET = SUMMARY_FOLDER / 'RLS_Incremental_by_dataset.csv'
OUTPUT_OVERALL = SUMMARY_FOLDER / 'RLS_Incremental_overall.csv'
