...
DATASETS = ['IDS01', 'IDS02', 'IDS03', 'IDS04', 'IDS05', 'IDS06']
DATASET_PREFIX = 'IDS'
EXPERIMENT_MODEL_NAME = 'WidrowHoff'
SUMMARY_FILE_MODEL_SLUG = 'WidrowHoff'
MODEL_LABEL = 'WidrowHoff-SCCM'
DRIFT_TYPE = 'incremental'
DRIFT_DISPLAY = 'Incremental'

OUTPUT_BY_DATASET = SUMMARY_FOLDER / 'WidrowHoff_Incremental_by_dataset.csv'
OUTPUT_OVERALL = SUMMARY_FOLDER / 'WidrowHoff_Incremental_overall.csv'
