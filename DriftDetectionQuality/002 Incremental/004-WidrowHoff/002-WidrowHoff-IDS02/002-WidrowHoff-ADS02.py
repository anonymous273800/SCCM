...
from Datasets.Synthetic.Abrupt import ADS02
import warnings
...
def run_multi_seed_experiment(
    ...
    for seed in seeds:
        ...
        X, y, X1, y1, X2, y2, meta = ADS02.get_DS02(seed=seed, return_meta=True)
        ...
        ADS02.print_DS02_info(X, y, X1, y1, X2, y2, meta)
...
if __name__ == "__main__":
    ...
    EXPERIMENT_NAME = "ADS02_abrupt_exp2_WidrowHoff"
    DATASET_NAME = "ADS02"
    DRIFT_TYPE = "abrupt"
    DRIFT_LOCATION = 500
    PLOTTING_ENABLED = True
    TRAIN_PERCENT = 90
    PLOTTING_DIR = '002-WidrowHoff-ADS02'
