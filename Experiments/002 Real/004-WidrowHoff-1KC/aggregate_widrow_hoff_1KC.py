...
gen_path = Path(
    r"C:/PythonProjects/SCCM-StreamCruiseControlMethod/Experiments/002 Real/004-WidrowHoff-1KC"
)
expr1_path = gen_path / "004-WH-1KC" / "004-WH_realdataset_exp4_expr_data.txt"
