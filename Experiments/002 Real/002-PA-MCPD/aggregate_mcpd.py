...
gen_path = Path(
    r"C:/PythonProjects/SCCM-StreamCruiseControlMethod/Experiments/002 Real/002-PA-MCPD"
)

expr1_path = gen_path / "002-PA-MCPD" / "002-MCPD_realdataset_exp2_expr_data.txt"
