...
gen_path = r"C:\PythonProjects\SCCM-StreamCruiseControlMethod\Experiments\001 Synthetic\002 Incremental\002-PA"

expr1 = read_file(gen_path + r"\001-PA-IDS01\001-PA-IDS01\IDS01_incremental_exp1_PA_expr_data.txt")
expr2 = read_file(gen_path + r"\002-PA-IDS02\002-PA-IDS02\IDS02_incremental_exp2_PA_expr_data.txt")
expr3 = read_file(gen_path + r"\003-PA-IDS03\003-PA-IDS03\IDS03_incremental_exp3_PA_expr_data.txt")
expr4 = read_file(gen_path + r"\004-PA-IDS04\004-PA-IDS04\IDS04_incremental_exp4_PA_expr_data.txt")
expr5 = read_file(gen_path + r"\005-PA-IDS05\005-PA-IDS05\IDS05_incremental_exp5_PA_expr_data.txt")
expr6 = read_file(gen_path + r"\006-PA-IDS06\006-PA-IDS06\IDS06_incremental_exp6_PA_expr_data.txt")
...
for exp in experiments:
    ...
    # PA does not use increment_size for reporting.
