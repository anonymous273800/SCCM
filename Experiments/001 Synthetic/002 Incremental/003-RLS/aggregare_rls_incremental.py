...
gen_path = r"C:\PythonProjects\SCCM-StreamCruiseControlMethod\Experiments\001 Synthetic\002 Incremental\003-RLS"

expr1 = read_file(gen_path + r"\001-RLS-IDS01\001-RLS-IDS01\IDS01_incremental_exp1_RLS_expr_data.txt")
expr2 = read_file(gen_path + r"\002-RLS-IDS02\002-RLS-IDS02\IDS02_incremental_exp2_RLS_expr_data.txt")
expr3 = read_file(gen_path + r"\003-RLS-IDS03\003-RLS-IDS03\IDS03_incremental_exp3_RLS_expr_data.txt")
expr4 = read_file(gen_path + r"\004-RLS-IDS04\004-RLS-IDS04\IDS04_incremental_exp4_RLS_expr_data.txt")
expr5 = read_file(gen_path + r"\005-RLS-IDS05\005-RLS-IDS05\IDS05_incremental_exp5_RLS_expr_data.txt")
expr6 = read_file(gen_path + r"\006-RLS-IDS06\006-RLS-IDS06\IDS06_incremental_exp6_RLS_expr_data.txt")
