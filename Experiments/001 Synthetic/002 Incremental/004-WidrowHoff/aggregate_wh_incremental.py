...
def get_report_idx(drift_location, report_interval):
    """
    PA processes one point at a time, but MSE is reported every report_interval points.

    Example:
        report_interval = 10
        drift_location = 300

        metric index = 300 // 10 = 30

    This points to the first reported MSE after the drift location.
    """
...
gen_path = r"C:\PythonProjects\SCCM-StreamCruiseControlMethod\Experiments\001 Synthetic\002 Incremental\004-WidrowHoff"

expr1 = read_file(gen_path + r"\001-WidrowHoff-IDS01\001-WidrowHoff-IDS01\IDS01_incremental_exp1_WidrowHoff_expr_data.txt")
expr2 = read_file(gen_path + r"\002-WidrowHoff-IDS02\002-WidrowHoff-IDS02\IDS02_incremental_exp2_WidrowHoff_expr_data.txt")
expr3 = read_file(gen_path + r"\003-WidrowHoff-IDS03\003-WidrowHoff-IDS03\IDS03_incremental_exp3_WidrowHoff_expr_data.txt")
expr4 = read_file(gen_path + r"\004-WidrowHoff-IDS04\004-WidrowHoff-IDS04\IDS04_incremental_exp4_WidrowHoff_expr_data.txt")
expr5 = read_file(gen_path + r"\005-WidrowHoff-IDS05\005-WidrowHoff-IDS05\IDS05_incremental_exp5_WidrowHoff_expr_data.txt")
expr6 = read_file(gen_path + r"\006-WidrowHoff-IDS06\006-WidrowHoff-IDS06\IDS06_incremental_exp6_WidrowHoff_expr_data.txt")
...
for exp in experiments:
    ...
    # RLS does not use increment_size for reporting.
    # It reports MSE every report_interval points.
