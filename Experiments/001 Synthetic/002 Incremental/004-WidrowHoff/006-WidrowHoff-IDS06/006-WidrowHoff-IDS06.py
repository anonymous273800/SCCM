...
from Datasets.Synthetic.Incremental import IDS06
import warnings
...
def run_multi_seed_experiment(
    ...
    for seed in seeds:
        ...
        X, y, X_steps, y_steps, meta = IDS06.get_IDS06(seed=seed, return_meta=True)
        ...
        IDS06.print_IDS06_info(X, y, X_steps, y_steps, meta)
...
if __name__ == "__main__":
    ...
    EXPERIMENT_NAME = "IDS06_incremental_exp6_WidrowHoff"
    DATASET_NAME = "IDS06"
    DRIFT_TYPE = "incremental"
    DRIFT_LOCATION = 200 # every 100
    PLOTTING_ENABLED = True
    TRAIN_PERCENT = 90
    PLOTTING_DIR = '006-WidrowHoff-IDS06'
