...
from Datasets.Synthetic.Incremental import IDS03
import warnings
...
def run_multi_seed_experiment(
    ...
    for seed in seeds:
        ...
        X, y, X_steps, y_steps, meta = IDS03.get_IDS03(seed=seed, return_meta=True)
        ...
        IDS03.print_IDS03_info(X, y, X_steps, y_steps, meta)
...
if __name__ == "__main__":
    ...
    EXPERIMENT_NAME = "IDS03_incremental_exp3_WidrowHoff"
    DATASET_NAME = "IDS03"
    DRIFT_TYPE = "incremental"
    DRIFT_LOCATION = 100 # every 100
    PLOTTING_ENABLED = True
    TRAIN_PERCENT = 90
    PLOTTING_DIR = '003-WidrowHoff-IDS03'
