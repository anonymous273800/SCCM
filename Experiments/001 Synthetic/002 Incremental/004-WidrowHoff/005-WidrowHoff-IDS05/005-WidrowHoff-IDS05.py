...
from Datasets.Synthetic.Incremental import IDS05
import warnings
...
def run_multi_seed_experiment(
    ...
    for seed in seeds:
        ...
        X, y, X_steps, y_steps, meta = IDS05.get_IDS05(seed=seed, return_meta=True)
        ...
        IDS05.print_IDS05_info(X, y, X_steps, y_steps, meta)
...
if __name__ == "__main__":
    ...
    EXPERIMENT_NAME = "IDS05_incremental_exp5_WidrowHoff"
    DATASET_NAME = "IDS05"
    DRIFT_TYPE = "incremental"
    DRIFT_LOCATION = 200 # every 100
    PLOTTING_ENABLED = True
    TRAIN_PERCENT = 90
    PLOTTING_DIR = '005-WidrowHoff-IDS05'
