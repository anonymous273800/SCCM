...
from Datasets.Synthetic.Incremental import IDS04
import warnings
...
def run_multi_seed_experiment(
    ...
    for seed in seeds:
        ...
        X, y, X_steps, y_steps, meta = IDS04.get_IDS04(seed=seed, return_meta=True)
        ...
        IDS04.print_IDS04_info(X, y, X_steps, y_steps, meta)
...
if __name__ == "__main__":
    ...
    EXPERIMENT_NAME = "IDS04_incremental_exp4_WidrowHoff"
    DATASET_NAME = "IDS04"
    DRIFT_TYPE = "incremental"
    DRIFT_LOCATION = 200 # every 100
    PLOTTING_ENABLED = True
    TRAIN_PERCENT = 90
    PLOTTING_DIR = '004-WidrowHoff-IDS04'
