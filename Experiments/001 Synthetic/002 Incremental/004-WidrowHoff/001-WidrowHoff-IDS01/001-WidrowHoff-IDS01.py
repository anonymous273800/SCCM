...
from Datasets.Synthetic.Incremental import IDS01
import warnings
...
def run_multi_seed_experiment(
    ...
    for seed in seeds:
        ...
        X, y, X_steps, y_steps, meta = IDS01.get_IDS01(seed=seed, return_meta=True)
        ...
        IDS01.print_IDS01_info(X, y, X_steps, y_steps, meta)
...
if __name__ == "__main__":
    ...
    EXPERIMENT_NAME = "IDS01_incremental_exp1_WidrowHoff"
    DATASET_NAME = "IDS01"
    DRIFT_TYPE = "incremental"
    DRIFT_LOCATION = 100 # every 100
    PLOTTING_ENABLED = True
    TRAIN_PERCENT = 90
    PLOTTING_DIR = '001-WidrowHoff-IDS01'
