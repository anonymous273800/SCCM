...
from Datasets.Synthetic.Incremental import IDS02
import warnings
...
def run_multi_seed_experiment(
    ...
    for seed in seeds:
        ...
        X, y, X_steps, y_steps, meta = IDS02.get_IDS02(seed=seed, return_meta=True)
        ...
        IDS02.print_IDS02_info(X, y, X_steps, y_steps, meta)
...
if __name__ == "__main__":
    ...
    EXPERIMENT_NAME = "IDS02_incremental_exp2_WidrowHoff"
    DATASET_NAME = "IDS02"
    DRIFT_TYPE = "incremental"
    DRIFT_LOCATION = 100 # every 100
    PLOTTING_ENABLED = True
    TRAIN_PERCENT = 90
    PLOTTING_DIR = '002-WidrowHoff-IDS02'
