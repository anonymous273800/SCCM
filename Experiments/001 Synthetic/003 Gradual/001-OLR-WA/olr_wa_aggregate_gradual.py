...
def get_gradual_drift_locations(dataset_name):
    """
    Gradual drift locations:
    GDS01, GDS02, GDS03: total samples = 1000
        drift occurs at [300, 400, 500, 600, 700]

    GDS04, GDS05, GDS06: total samples = 2000
        drift occurs at [600, 800, 1000, 1200, 1400]
    """
...
gen_path = r"C:\PythonProjects\SCCM-StreamCruiseControlMethod\Experiments\001 Synthetic\003 Gradual\001-OLR-WA"
expr1 = read_file(gen_path + r"\001-OLR-WA-GDS01\001-OLR-WA-GDS01\GDS01_gradual_exp1_expr_data.txt")
expr2 = read_file(gen_path + r"\002-OLR-WA-GDS02\002-OLR-WA-GDS02\GDS02_gradual_exp2_expr_data.txt")
expr3 = read_file(gen_path + r"\003-OLR-WA-GDS03\003-OLR-WA-GDS03\GDS03_gradual_exp3_expr_data.txt")
expr4 = read_file(gen_path + r"\004-OLR-WA-GDS04\004-OLR-WA-GDS04\GDS04_gradual_exp4_expr_data.txt")
expr5 = read_file(gen_path + r"\005-OLR-WA-GDS05\005-OLR-WA-GDS05\GDS05_gradual_exp5_expr_data.txt")
expr6 = read_file(gen_path + r"\006-OLR-WA-GDS06\006-OLR-WA-GDS06\GDS06_gradual_exp6_expr_data.txt")
...
for exp in experiments:
    ...
    drift_locations = get_gradual_drift_locations(dataset_name)
