...
gen_path = r"C:\PythonProjects\SCCM-StreamCruiseControlMethod\Experiments\001 Synthetic\003 Gradual\002-PA"

expr1 = read_file(gen_path + r"\001-PA-GDS01\001-PA-GDS01\GDS01_gradual_exp1_PA_expr_data.txt")
expr2 = read_file(gen_path + r"\002-PA-GDS02\002-PA-GDS02\GDS02_gradual_exp2_PA_expr_data.txt")
expr3 = read_file(gen_path + r"\003-PA-GDS03\003-PA-GDS03\GDS03_gradual_exp3_PA_expr_data.txt")
expr4 = read_file(gen_path + r"\004-PA-GDS04\004-PA-GDS04\GDS04_gradual_exp4_PA_expr_data.txt")
expr5 = read_file(gen_path + r"\005-PA-GDS05\005-PA-GDS05\GDS05_gradual_exp5_PA_expr_data.txt")
expr6 = read_file(gen_path + r"\006-PA-GDS06\006-PA-GDS06\GDS06_gradual_exp6_PA_expr_data.txt")
