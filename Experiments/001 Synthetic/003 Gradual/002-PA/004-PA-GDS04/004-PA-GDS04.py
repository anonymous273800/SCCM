...
from Datasets.Synthetic.Gradual import GDS04
import warnings
...
def run_multi_seed_experiment(
    ...
    for seed in seeds:
        ...
        X, y, X1, y1, X2, y2, meta = GDS04.get_GDS04(seed=seed, return_meta=True)
        ...
        GDS04.print_GDS04_info(X, y, X1, y1, X2, y2, meta)
...
if __name__ == "__main__":
    ...
    EXPERIMENT_NAME = "GDS04_gradual_exp4_PA"
    DATASET_NAME = "GDS04"
    DRIFT_TYPE = "gradual"
