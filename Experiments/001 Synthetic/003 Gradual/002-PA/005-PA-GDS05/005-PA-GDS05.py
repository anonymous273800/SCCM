...
from Datasets.Synthetic.Gradual import GDS05
import warnings
...
def run_multi_seed_experiment(
    ...
    for seed in seeds:
        ...
        X, y, X1, y1, X2, y2, meta = GDS05.get_GDS05(seed=seed, return_meta=True)
        ...
        GDS05.print_GDS05_info(X, y, X1, y1, X2, y2, meta)
...
if __name__ == "__main__":
    ...
    EXPERIMENT_NAME = "GDS05_gradual_exp5_PA"
    DATASET_NAME = "GDS05"
    DRIFT_TYPE = "gradual"
    GRADUAL_DRIFT_LOCATIONS = [600, 800, 1000, 1200, 1400, 6000]
    GRADUAL_DRIFT_CONCEPTS = ['c1', 'c2', 'c1', 'c2', 'c1', 'c2']
    DRIFT_LOCATION = None
    PLOTTING_ENABLED = True
    TRAIN_PERCENT = 90
    PLOTTING_DIR = '005-PA-GDS05'
