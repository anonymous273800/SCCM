...
from Datasets.Synthetic.Gradual import GDS03
import warnings
...
def run_multi_seed_experiment(
    ...
    for seed in seeds:
        ...
        X, y, X1, y1, X2, y2, meta = GDS03.get_GDS03(seed=seed, return_meta=True)
        ...
        GDS03.print_GDS03_info(X, y, X1, y1, X2, y2, meta)
...
if __name__ == "__main__":
    ...
    EXPERIMENT_NAME = "GDS03_gradual_exp3_WidrowHoff"
    DATASET_NAME = "GDS03"
    DRIFT_TYPE = "gradual"
    DRIFT_LOCATION = None
    PLOTTING_ENABLED = True
    TRAIN_PERCENT = 90
    PLOTTING_DIR = '003-WidrowHoff-GDS03'
    GRADUAL_DRIFT_LOCATIONS = [300, 400, 500, 600, 700, 1000]
