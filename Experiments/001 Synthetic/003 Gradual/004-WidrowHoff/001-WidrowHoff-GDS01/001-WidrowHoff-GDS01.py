...
from Datasets.Synthetic.Gradual import GDS01
import warnings
...
def run_multi_seed_experiment(
    ...
    for seed in seeds:
        ...
        X, y, X1, y1, X2, y2, meta = GDS01.get_GDS01(seed=seed, return_meta=True)
        ...
        GDS01.print_GDS01_info(X, y, X1, y1, X2, y2, meta)
...
if __name__ == "__main__":
    ...
    EXPERIMENT_NAME = "GDS01_gradual_exp1_WidrowHoff"
    DATASET_NAME = "GDS01"
    DRIFT_TYPE = "gradual"
    DRIFT_LOCATION = None
    PLOTTING_ENABLED = True
    TRAIN_PERCENT = 90
    PLOTTING_DIR = '001-WidrowHoff-GDS01'
