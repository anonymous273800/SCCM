...
gen_path = r"C:\PythonProjects\SCCM-StreamCruiseControlMethod\Experiments\001 Synthetic\003 Gradual\004-WidrowHoff"

expr1 = read_file(gen_path + r"\001-WidrowHoff-GDS01\001-WidrowHoff-GDS01\GDS01_gradual_exp1_WidrowHoff_expr_data.txt")
expr2 = read_file(gen_path + r"\002-WidrowHoff-GDS02\002-WidrowHoff-GDS02\GDS02_gradual_exp2_WidrowHoff_expr_data.txt")
expr3 = read_file(gen_path + r"\003-WidrowHoff-GDS03\003-WidrowHoff-GDS03\GDS03_gradual_exp3_WidrowHoff_expr_data.txt")
expr4 = read_file(gen_path + r"\004-WidrowHoff-GDS04\004-WidrowHoff-GDS04\GDS04_gradual_exp4_WidrowHoff_expr_data.txt")
expr5 = read_file(gen_path + r"\005-WidrowHoff-GDS05\005-WidrowHoff-GDS05\GDS05_gradual_exp5_WidrowHoff_expr_data.txt")
expr6 = read_file(gen_path + r"\006-WidrowHoff-GDS06\006-WidrowHoff-GDS06\GDS06_gradual_exp6_WidrowHoff_expr_data.txt")
