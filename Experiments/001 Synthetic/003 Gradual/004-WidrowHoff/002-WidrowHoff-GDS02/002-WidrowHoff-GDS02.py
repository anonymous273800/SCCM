...
from Datasets.Synthetic.Gradual import GDS02
import warnings
...
def run_multi_seed_experiment(
    ...
    for seed in seeds:
        ...
        X, y, X1, y1, X2, y2, meta = GDS02.get_GDS02(seed=seed, return_meta=True)
        ...
        GDS02.print_GDS02_info(X, y, X1, y1, X2, y2, meta)
...
if __name__ == "__main__":
    ...
    EXPERIMENT_NAME = "GDS02_gradual_exp2_WidrowHoff"
    DATASET_NAME = "GDS02"
    DRIFT_TYPE = "gradual"
    DRIFT_LOCATION = None
    PLOTTING_ENABLED = True
    TRAIN_PERCENT = 90
    PLOTTING_DIR = '002-WidrowHoff-GDS02'
