...
gen_path = r"C:\PythonProjects\SCCM-StreamCruiseControlMethod\Experiments\001 Synthetic\001 Abrupt\002-PA"

expr1 = read_file(gen_path + r"\001-PA-DS01\001-PA-ADS01\ADS01_abrupt_exp1_PA_expr_data.txt")
expr2 = read_file(gen_path + r"\002-PA-DS02\002-PA-ADS02\ADS02_abrupt_exp2_PA_expr_data.txt")
expr3 = read_file(gen_path + r"\003-PA-DS03\003-PA-ADS03\ADS03_abrupt_exp3_PA_expr_data.txt")
expr4 = read_file(gen_path + r"\004-PA-DS04\004-PA-ADS04\ADS04_abrupt_exp4_PA_expr_data.txt")
expr5 = read_file(gen_path + r"\005-PA-DS05\005-PA-ADS05\ADS05_abrupt_exp5_PA_expr_data.txt")
expr6 = read_file(gen_path + r"\006-PA-DS06\006-PA-ADS06\ADS06_abrupt_exp6_PA_expr_data.txt")
