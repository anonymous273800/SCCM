...
gen_path = r"C:\PythonProjects\SCCM-StreamCruiseControlMethod\Experiments\001 Synthetic\001 Abrupt\004-WidrowHoff"

expr1 = read_file(gen_path + r"\001-WidrowHoff-DS01\001-WidrowHoff-ADS01\ADS01_abrupt_exp1_WidrowHoff_expr_data.txt")
expr2 = read_file(gen_path + r"\002-WidrowHoff-DS02\002-WidrowHoff-ADS02\ADS02_abrupt_exp2_WidrowHoff_expr_data.txt")
expr3 = read_file(gen_path + r"\003-WidrowHoff-DS03\003-WidrowHoff-ADS03\ADS03_abrupt_exp3_WidrowHoff_expr_data.txt")
expr4 = read_file(gen_path + r"\004-WidrowHoff-DS04\004-WidrowHoff-ADS04\ADS04_abrupt_exp4_WidrowHoff_expr_data.txt")
expr5 = read_file(gen_path + r"\005-WidrowHoff-DS05\005-WidrowHoff-ADS05\ADS05_abrupt_exp5_WidrowHoff_expr_data.txt")
expr6 = read_file(gen_path + r"\006-WidrowHoff-DS06\006-WidrowHoff-ADS06\ADS06_abrupt_exp6_WidrowHoff_expr_data.txt")
