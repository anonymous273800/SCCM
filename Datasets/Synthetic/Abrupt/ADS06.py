...
def print_DS06_info(X, y, X1, y1, X2, y2, meta):
    print_dataset_info(X, y, X1, y1, X2, y2, meta)


if __name__ == "__main__":
    X, y, X1, y1, X2, y2, meta = get_DS06(return_meta=True)
    print_DS06_info(X, y, X1, y1, X2, y2, meta)
    plot_abrupt_dataset(X1, y1, X2, y2, title="DS06: Abrupt Drift in High-D Regression (High, Large)")