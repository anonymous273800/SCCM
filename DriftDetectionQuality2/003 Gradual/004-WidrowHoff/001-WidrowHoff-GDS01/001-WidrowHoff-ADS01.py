...
def run_multi_seed_experiment(
    ...
    for seed in seeds:
        ...
        X, y, X1, y1, X2, y2, meta = ADS01.get_DS01(seed=seed, return_meta=True)
        ...
        ADS01.print_DS01_info(X, y, X1, y1, X2, y2, meta)
...
if __name__ == "__main__":
    ...
    EXPERIMENT_NAME = "ADS01_abrupt_exp1_WidrowHoff"
    DATASET_NAME = "ADS01"
    DRIFT_TYPE = "abrupt"
    DRIFT_LOCATION = 500
    PLOTTING_ENABLED = True
    TRAIN_PERCENT = 90
    PLOTTING_DIR = '001-WidrowHoff-ADS01'
