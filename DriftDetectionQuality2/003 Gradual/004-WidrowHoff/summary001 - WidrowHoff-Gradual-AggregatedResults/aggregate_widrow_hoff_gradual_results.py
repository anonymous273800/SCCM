...
DATASETS = ['GDS01', 'GDS02', 'GDS03', 'GDS04', 'GDS05', 'GDS06']
DATASET_PREFIX = 'GDS'
EXPERIMENT_MODEL_NAME = 'WidrowHoff'
SUMMARY_FILE_MODEL_SLUG = 'WidrowHoff'
MODEL_LABEL = 'WidrowHoff-SCCM'
DRIFT_TYPE = 'gradual'
DRIFT_DISPLAY = 'Gradual'

OUTPUT_BY_DATASET = SUMMARY_FOLDER / 'WidrowHoff_Gradual_by_dataset.csv'
OUTPUT_OVERALL = SUMMARY_FOLDER / 'WidrowHoff_Gradual_overall.csv'
