...
from Datasets.Synthetic.Abrupt import ADS06
import warnings
...
def run_multi_seed_experiment(
    ...
    for seed in seeds:
        ...
        X, y, X1, y1, X2, y2, meta = ADS06.get_DS06(seed=seed, return_meta=True)
        ...
        ADS06.print_DS06_info(X, y, X1, y1, X2, y2, meta)
...
if __name__ == "__main__":
    ...
    EXPERIMENT_NAME = "ADS06_abrupt_exp6_WidrowHoff"
    DATASET_NAME = "ADS06"
    DRIFT_TYPE = "abrupt"
    DRIFT_LOCATION = 1000
    PLOTTING_ENABLED = True
    TRAIN_PERCENT = 90
    PLOTTING_DIR = '006-WidrowHoff-ADS06'
