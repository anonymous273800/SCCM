...
from Datasets.Synthetic.Abrupt import ADS03
import warnings
from Utils import Util
from Models.WidrowHoff import WidrowHoff
from Models.WidrowHoff import WidrowHoff_SCCM_DriftQuality as WidrowHoff_SCCM
...
def run_multi_seed_experiment(
    ...
    for seed in seeds:
        ...
        X, y, X1, y1, X2, y2, meta = ADS03.get_DS03(seed=seed, return_meta=True)
        ...
        ADS03.print_DS03_info(X, y, X1, y1, X2, y2, meta)
...
if __name__ == "__main__":
    ...
    EXPERIMENT_NAME = "ADS03_abrupt_exp3_WidrowHoff"
    DATASET_NAME = "ADS03"
    DRIFT_TYPE = "abrupt"
    DRIFT_LOCATION = 500
    PLOTTING_ENABLED = True
    TRAIN_PERCENT = 90
    PLOTTING_DIR = '003-WidrowHoff-ADS03'
